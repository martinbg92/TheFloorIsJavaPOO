...
public class ShowPedidosPendientesDeEnvioController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        colRealizadoEn.setCellValueFactory(new PropertyValueFactory<>("FechaYHoraDelPedidoString"));
    ...
    ObservableList<Pedido> observableList = FXCollections.observableList( new PedidoDAO().getPedidosPendientesDeEnvio());
