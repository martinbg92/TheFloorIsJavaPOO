...
public class ShowClientesEstandarController implements Initializable {
    ...
    ObservableList<Cliente> observableList = FXCollections.observableList( new ClienteDAO().getClientesEstandar());
