...
public class ShowClientesPremiumController implements Initializable {
    ...
    ObservableList<Cliente> observableList = FXCollections.observableList( new ClienteDAO().getClientesPremium());
